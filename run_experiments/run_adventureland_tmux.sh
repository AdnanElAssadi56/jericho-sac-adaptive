...
SESSION="final_adventureland"

# Base output directory
BASE_OUT="logging/final"

# ROM and spm - use absolute paths
ROM="${SCRIPT_DIR}/dependencies/z-machine-games-master/jericho-game-suite/adventureland.z5"
...
for i in "${!NAMES[@]}"; do
  ...
  for seed in "${SEEDS[@]}"; do
    outdir="${SCRIPT_DIR}/${BASE_OUT}/adventureland/seed${seed}/${name}"
