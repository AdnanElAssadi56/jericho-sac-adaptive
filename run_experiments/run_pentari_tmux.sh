...
SESSION="final_pentari"

# Base output directory
BASE_OUT="logging/final"

# ROM and spm - use absolute paths
ROM="${SCRIPT_DIR}/dependencies/z-machine-games-master/jericho-game-suite/pentari.z5"
